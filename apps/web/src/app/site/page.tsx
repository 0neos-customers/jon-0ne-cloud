  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center max-w-3xl mx-auto">
        <div className="mb-8">
          <span className="inline-block px-3 py-1 text-xs font-medium rounded-full bg-[var(--color-orange)]/10 text-[var(--color-orange)]">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="/install"
            className="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-[var(--color-orange)] rounded-lg hover:bg-[var(--color-orange-dark)] transition-colors"
          >
            Get Started
          </a>
          <a
            href="#features"
            className="inline-flex items-center justify-center px-8 py-3 text-base font-semibold text-[var(--color-charcoal)] bg-white rounded-lg border border-[var(--color-charcoal)]/10 hover:border-[var(--color-charcoal)]/20 transition-colors"
          >
            See What&apos;s Inside
          </a>
        </div>
      ...
      <section className="px-6 py-20 text-center">
        <div className="max-w-2xl mx-auto bg-[var(--color-dark)] rounded-2xl p-12">
...
function Feature({
  ...
  return (
    <div className="p-6 rounded-xl bg-white border border-[var(--color-charcoal)]/5">
